...
?>
    ...
    <section class="content">
        ...
        <div class="box">
            ...
            <div class="box-body">
                <div class="">
                <?=$this->Form->create('ProductCategory', ['role' => 'form', 'class' => 'form-horizontal']);?>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <?=$this->Form->input('category_name', ['class' => 'form-control input-sm', 'div' => false, 'label' => false, 'placeholder' => 'Masukan nama category', 'required']);?>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="col-md-9">
