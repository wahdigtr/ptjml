...
<!-- 	<div class="content-header ">
	...
	<div class="inner-content clearfix">
		<div class="col-3">
			...
			<div class="well">
				<?=$this->Form->create(null, ['url' => ['controller' => 'products','action' => 'product_search'], 'type' => 'get']);?>
		...
		<div class="col-9">
			<div class="content-header">
				<h3>By Category : <i><?=$category_data['Category']['name'];?></i></h3>
			</div>
			<?php
				if(count($list_product) > 0){
					foreach ($list_product as $key => $value) {
						...
						$url_product = Router::url(['controller' => 'products', 'action' => 'product_detail', 'id' => $value['Product']['id'], 'slug' => $slug], true);
						echo '
