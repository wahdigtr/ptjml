	...
	<div class="inner-content clearfix">
		...
		<div class="col-9">
							...
							<div class="panel-body">
								...
								<ul class="nav nav-tabs" role="tablist">
									...
									<li role="presentation">
										<a href="#spec" aria-controls="spec" role="tab" data-toggle="tab">Spec</a>
									</li>
									<li role="presentation">
										<a href="#feature" aria-controls="feature" role="tab" data-toggle="tab">Feature</a>
									</li>
								</ul>
								...
								<div class="tab-content" style="padding:10px;">
									...
									<div role="tabpanel" class="tab-pane" id="spec">
										<?=$data_product['Product']['spec'];?>
									</div>
									<div role="tabpanel" class="tab-pane" id="messages">
										<?=$data_product['Product']['feature'];?>
									</div>
								</div>	
			...
			<div class="col-xs-12 text-right">
				<?=$this->Html->link('Pre-Order Now', ['controller' => 'po_lists', 'action' => 'order'],['class' => 'btn btn-success btn-lg']);?>
			</div>
		</div>
	</div>
</section>
