            ...
            <div class="box-body">
                ...
                <?=$this->Form->create('Product', ['role' => 'form', 'class' => 'form-horizontal', 'type' => 'file']);?>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <?=$this->Form->file('cover', [ 'div' => false, 'label' => false]);?>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-12">
                            <?=$this->Form->textarea('other_info', ['class' => 'form-control input-sm', 'div' => false, 'label' => false, 'placeholder' => 'Masukan informasi lainnya', 'required', 'id' => 'editor1']);?>
                        </div>
                    </div>
                    <div class="form-group">
...
<?php
        ...
        echo $this->Html->scriptBlock(
                '
                    ...
                    var id = "'.$this->request->data['Product']['product_group_id'].'";
                    $.ajax({
                        method: "POST",
                        url: "'.$url_category.'",
                        data: {"id" : id},
